...
# criteria = "RSD_robust"            # This can be one of: "RSD_robust" (relative standard deviation), "RSD" (relative standard deviation), "MSE" (mean squared error), or "TSS" (total sum of squares). This is the criteria to be minimized.
...
# For RSD:
test.breaks = 13 ; test.window = 9; test.index = 14; criteria = "RSD_robust"; quantile_increment = 0.05; n.cores = 1
